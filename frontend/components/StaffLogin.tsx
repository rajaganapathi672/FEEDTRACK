...
export const StaffLogin: React.FC<StaffLoginProps> = ({ onBack, onLogin, onSwitchToSignup, loading, error }) => {
        ...
        <div className="bg-background-dark text-white overflow-hidden selection:bg-white selection:text-black fixed inset-0 z-50">
            <nav className="fixed top-0 left-0 w-full z-50 p-8 flex justify-between items-center pointer-events-none">
                ...
                <div className="hidden md:block font-mono text-[10px] uppercase tracking-[0.3em] text-white/30">
                    Staff Portal Access / Alpha 2.0
                </div>
            </nav>

            <main className="relative min-h-screen w-full flex flex-col md:flex-row">
                <section className="relative flex flex-1 staff-gradient-bg flex-col justify-center px-12 md:px-24 py-20 md:py-0 overflow-hidden border-r border-white/5">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="max-w-md text-white/40 font-sans text-sm leading-loose tracking-wide">
                            Manage institutional feedback and administrative metrics. Your secure access facilitates data analysis and organizational alignment.
                        </p>
                    </div>
                ...
                <section className="relative flex-1 bg-charcoal flex flex-col justify-center px-8 md:px-24 py-12 md:py-0">
                    ...
                    <div className="relative z-10 w-full max-w-sm mx-auto md:mx-0">
                        <div className="mb-16">
                            ...
                            <p className="font-mono text-[10px] uppercase tracking-widest text-white/40">Staff Identification Required</p>
                        </div>

                        <form className="space-y-12" onSubmit={handleSubmit}>
                            <div className="space-y-1">
                                <label className="font-mono text-[10px] uppercase tracking-widest text-white/30" htmlFor="staff-id">Staff ID</label>
                                <input
